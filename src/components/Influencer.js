    ...
    return(
        <div style={{display:"flex",alignItems:"center",justifyContent:"center",width:"100%",backgroundColor:styles.colors.orange}}>
            ...
            <div style={{marginTop:100,marginLeft:70}}>
                ...
                <div style={{marginTop:45,color:"white",fontSize:30,maxWidth:520}}>Você já é um criador de conteúdo ou deseja se tornar um? Esse serviço é feito para você! Conte com a Lumni para criar o universo visual do seu meio de comunicação e cativar o seu público.</div>
